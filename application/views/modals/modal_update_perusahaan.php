  ...
  <h3 style="display:block; text-align:center;">Update Data Perusahaan</h3>
      <form method="POST" id="form-update-perusahaan">
        ...
        <div class="input-group form-group">
          ...
          <input type="text" class="form-control" placeholder="NamaPerusahaan" name="nm_perusahaan" aria-describedby="sizing-addon2" value="<?php echo $dataPerusahaan->nm_perusahaan; ?>">
        </div>
        <div class="input-group form-group">
          <span class="input-group-addon" id="sizing-addon2">
...
<!--         <div class="input-group form-group">
        ...
        <div class="input-group form-group" id="myStatusDiv">
          ...
          <?php 
            if($dataPerusahaan->id_izin != 2) {
          ?>
              <input type="text" name="status" class="form-control" aria-describedby="sizing-addon2" value="<?php echo $dataPerusahaan->status; ?>" readonly="readonly"/>
          <?php
            }else{
          ?>
          <select id="select_status" name="status" class="form-control" aria-describedby="sizing-addon2">
...
<script type="text/javascript">
  $('#select_status').val("<?php echo $dataPerusahaan->status; ?>");
  
  console.log("<?php echo $dataPerusahaan->status; ?>");
</script>
<script type="text/javascript">
