<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <h3 style="display:block; text-align:center;">Tambah Admin Cabang Dinas</h3>
  ...
  <form id="form-tambah-admin" method="POST">
    ...
    <div class="input-group form-group">
      ...
      <input type="number" class="form-control" placeholder="Cabang Dinas Wilayah ESDM" name="cabdin_esdm" aria-describedby="sizing-addon2">
    </div>
