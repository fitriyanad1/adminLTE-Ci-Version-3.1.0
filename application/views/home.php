<div class="row">
  ...
  <div class="col-lg-4 col-xs-6">
    <div class="small-box bg-green">
      ...
      <a href="<?php echo base_url('Perusahaan') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
  ...
  <div class="col-lg-6 col-xs-12">
    <div class="box box-info">
      <div class="box-header with-border">
        ...
        <h3 class="box-title">Visualisasi Data PAD Kabupaten/Kota <small>Sektor MBLB</small></h3>
  ...
  <div class="col-lg-6 col-xs-12">
    <div class="box box-primary">
      <div class="box-header with-border">
        <i class="fa fa-briefcase"></i>
        <h3 class="box-title">Visualisasi Data Perusahaan Berproduksi Kabupaten/Kota <small>Sektor MBLB</small></h3>
