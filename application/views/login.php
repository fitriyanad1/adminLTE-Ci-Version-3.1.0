  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="<?php echo base_url(); ?>assets/index2.html"><b>E-Pejabat</b></a><br>
        <p><i><font size="4">Pelaporan, Produksi, Penjualan dan Pajak Mineral Bukan Logam dan Batuan</font></i></p>
      </div>
      ...
      <div class="login-box-body">
        ...
        <!-- <form action="<?php echo base_url('Auth/regis'); ?>" method="post">
          ...
          <!--   <div class="col-xs-offset-8 col-xs-4">
              <button type="submit" class="btn btn-primary btn-block btn-flat">Regis Admin</button>
            </div>
          </div>
        </form> --> 
